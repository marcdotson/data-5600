...
- This can help avoid overfitting and, by construction, multicollinearity (i.e., **each principal component is orthogonal** to the others)
:::

::: {.fragment}
Is PCR easy to interpret? [Does PCR perform variable selection or include shrinkage estimates?]{.fragment}
:::

## 

::: {.v-center}
![](../../figures/meme_pcr.png){fig-align="center"}
:::
...
<!-- TODO: Combine this act with the previous one and use this time to wrap up the course -->
