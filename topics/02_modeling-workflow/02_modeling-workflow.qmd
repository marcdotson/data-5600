...
::: {.column width="100%"}
A clearly specified objective can be translated into an objective function, often a **loss function**
...
::: {.fragment}
Using a loss function formalizes what we implicitly do when weighing pros and cons, though we are typically uncertain about $s$
:::
:::
...
::: {.column .gray-box width="42%"}
In the case, we want to maximize profit
