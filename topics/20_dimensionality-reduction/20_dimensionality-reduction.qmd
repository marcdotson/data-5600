...
- Each subsequent principal component finds the **next** largest variance where each is **orthogonal to all previous principal components**
:::
:::
...
::: {.v-center}
![](../../figures/meme_pca.png){fig-align="center"}
:::
