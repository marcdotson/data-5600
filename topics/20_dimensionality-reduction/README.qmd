...
To share their solution for Exercise 19, the randomly selected student is **___**.
...
Which approach seems best for your project: removing variables, penalized regression, or dimensionality reduction? Go the discussions to share before continuing with the lecture.

PCA is only useful when $k < p$, so how do we choose $k$? Go the discussions to share before finishing the lecture.
...
Try applying PCA to your predictors. Do you get principal components that make sense? Is this the right approach for your project?
