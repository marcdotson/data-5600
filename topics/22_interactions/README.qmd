...
To share their solution for Exercise 21, the randomly selected student is **___**.
...
What two-way interactions might be meaningful to include for your project? What do you expect? Go the discussions to share before continuing with the lecture.

Does including interactions make regularization, variable selection, and dimensionality reduction more or less relevant? Go the discussions to share before finishing the lecture.
...
Try including one or more two-way interactions in your model. Does it improve overall model fit?
