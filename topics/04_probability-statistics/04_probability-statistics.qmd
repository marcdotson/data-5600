...
```{python}
#| code-line-numbers: "|1|3-5|7-8|10-13|15-18|20"
#| eval: true
...
likelihood[0] = log_likelihood(y = data[0], x1 = data[1], x2 = data[2], 
  beta_0 = 5, beta_x1 = 3, beta_x2 = -2, sigma = 2
)

# How likely are the true values?
likelihood[1] = log_likelihood(y = data[0], x1 = data[1], x2 = data[2], 
  beta_0 = 2, beta_x1 = -0.3, beta_x2 = 4, sigma = 5
)
