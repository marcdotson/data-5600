...
Simulating data (forward) and estimating parameters (backward) with the
likelihood.
...
4.  Submit both your Quarto document and your code, printed output, and
    reflection as a PDF on Canvas
