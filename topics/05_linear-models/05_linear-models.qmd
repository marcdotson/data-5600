...
data_arr = sim_data(
  n = 100, beta_0 = 10, beta_price = -2, beta_discount = 3, 
  beta_online = 5, beta_promo = 3, sigma = 5
)

data_df = pl.DataFrame(
  data_arr, 
  schema = ['sales', 'price', 'discount', 'online', 'promo']
)
```
...
cont_df = (data_df
  .with_row_index('id')
  .select(['id', 'sales', 'price', 'discount'])
  .unpivot(
    on = ['sales', 'price', 'discount'], 
    index = 'id', 
