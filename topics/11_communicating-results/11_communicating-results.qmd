...
- Remember that statistical models capture association, not *necessarily* causation
...
The data is from a single, representative DMA across like store where each row represents a customer's category purchase during the test period
...
## Customers don't appear price sensitive
...
## Harmons and Skippy are indistinguishable from Jif
