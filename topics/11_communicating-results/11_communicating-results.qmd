...
Your presentation needs to be tailored for a **mixed audience** where you will have 8 minutes to present

[Use the rubric as a **set of guiding principles** for communicating clearly rather than just a checklist]{.fragment}
...
Your report needs to be written for a **technical audience** and should be structured using the **modeling workflow**
