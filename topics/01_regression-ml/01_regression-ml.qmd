...
::: {.incremental}
- Designed to complement exercise practice and group project work
- Includes questions about course concepts, exercise and project work (including code), and reflections on your performance in the course
...
::: {.incremental}
- You will complete two group projects, one focused on regression and another focused on classification
