...
Why do we need to reconcile the differences between the model and the
data? Go the discussions to share before continuing with the lecture.

What are the pros and cons of fitting a model using ordinary least
squares? Go the discussions to share before finishing the lecture.
...
1.  Return to your data from the previous exercise (or start with the
    exercise solution)
2.  Split the data into training and testing data, confirm any other
    feature engineering, and fit a model using OLS
...
Complete the feature engineering for your project and run an initial
model using OLS. Interpret the parameter estimates.
