...
2. Fit a second model with one predictor removed from the model
...
3. Take a backward step: Drop a predictor from the model if dropping the predictor improves overall model fit
