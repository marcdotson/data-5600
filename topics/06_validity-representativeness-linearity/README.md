...
Start working with your real project data. Conduct an exploratory data
analysis, clean up the data as needed, and walk through the validity,
representativeness, and linearity assumptions and justify whether or not
they are satisfied.
