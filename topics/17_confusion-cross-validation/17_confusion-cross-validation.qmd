...
::: {.column width="60%"}
::: {.incremental}
- How many true **true positives** do we have? [`40`]{.fragment}
- How many true **true negatives** do we have? [`3513`]{.fragment}
- How many true **false positives** (i.e., **type I errors**) do we have? [`51`]{.fragment}
- How many true **false negatives** (i.e., **type II errors**) do we have? [`7`]{.fragment}
:::
:::
...
::: {.column width="60%"}
::: {.incremental}
- **Accuracy** is the percent of correct predictions [`(40 + 3513)/3611 = 0.98`]{.fragment}
- We can compare accuracy to the **baseline accuracy** of always predicting the majority class [`(3513 + 51)/3611 = 0.99`]{.fragment}
- **Sensitivity** or **recall** is the percent of actual positives that were predicted correctly [`40/(40 + 7) = 0.85`]{.fragment}
- **Specificity** is the percent of actual negatives that were predicted correctly [`3513/(3513 + 51) = 0.99`]{.fragment}
:::
:::
...
::: {.column width="60%"}
::: {.incremental}
- **Precision** or **positive predictive value** is the percent of predicted positives that were predicted correctly [`40/(40 + 51) = 0.44`]{.fragment}
- **Negative predictive value** is the percent of predicted negatives that were predicted correctly [`3513/(3513 + 7) = 1`]{.fragment}
:::
:::
...
::: {.fragment}
We used `c = 0.05` for the previous example, but how could we choose a better cutoff? [Choose $c$ to minimize the misclassification rate]{.fragment}
:::
