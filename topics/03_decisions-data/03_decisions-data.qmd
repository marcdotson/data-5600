...
We don't know what the state of the world, but let's assume the probability of demand is 10% Low, 60% Medium, and 30% High
...
::: {.fragment}
Many decisions are made informally or using predictive rather than decision theoretic criteria
:::

::: {.fragment .fade-up .h-center}
### When should we use informal vs. formal decision-making?
:::
...
# What actions, states of the world, and loss/utility function might be relevant for your project? {background-color="#006242"}

# Data Generating Processes

## Narrate the data story

In order to inform decision-making, we need to **extract information from data** about the unknown state of the world $\theta$

## Start by identifying the ideal data
