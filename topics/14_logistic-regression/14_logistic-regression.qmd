...
- However, we can still run an OLS model to compute VIF for a model with a binary outcome since its based on the relationship among predictors and the way the model is estimated isn't relevant to estimating collinearity
:::
