# Linearity to Identifiability


During this class we will finish assumption diagnostics and remedies.
...
Why are residuals so helpful for assumption diagnostics? Go the
discussions to share before continuing with the lecture.

What does it mean that the variation is approximately normally
distributed? Go the discussions to share before finishing the lecture.
