...
- Fit the model and tune hyperparameters using cross-validation
- Evaluate cross-validated overall model fit
:::

[*Rerun the best-performing model on all of the training data and interpret results*]{.fragment}

[**Predict**]{.fragment}

::: {.incremental}
- Compute relevant predictions on the test data
- Use this to demonstrate the implications of the model
:::
