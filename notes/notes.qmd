...
- Where the name "regression" comes from -- extreme values "regressing" to the mean
...
- Exercise: Read case and describe how you might use regression and ML to inform the decision
- Wrap up
...
- Focus on being open/transparent and direct with objectives and assumptions
