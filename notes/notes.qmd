...
Wald's basic intuition was that statistics is nothing but the science of decision making under uncertainty. Statistical problems should be considered as special instances of general decision problems, where decisions have to be taken in the face of uncertainty. 
...
- Revisit loss/utility matrix with new case?
