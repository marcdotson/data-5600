...
- Use rubrics as a set of guiding questions rather than a checklist
...
- Exercise: Read case and describe how you might use regression and ML to inform the decision, complete the class survey
- Wrap up
...
- Get started (last time and preview)
