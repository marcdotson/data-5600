...
- Activity: Draw a simple data generating process for your project

## Keep loss and likelihood functions as simple as possible!

### Decision-Making in the Presence of Uncertainty as a Motivation for Probability

- Types of uncertainty: aleatoric vs. epistemic (meme)
