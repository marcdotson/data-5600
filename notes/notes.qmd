...
- Visualize the sigmoid / logistic function? As part of the EDA?
- These are all log-odds. We can use the inverse link function `inv_logit()` (i.e., the logistic function) to look at the estimates in the probability space.
