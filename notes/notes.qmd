...
- Inferential statistics (parametric modeling)
- Statistical decision theory (use extracted information to choose an action)

- Connect populations to data generating processes.
...
Recover parameters when there is only one kind of uncertainty
recovering parameters? MLE and Bayes and Bootstrap? (Build, Fit, Evaluate?)
