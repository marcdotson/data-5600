...
START USING EXISTING MATERIALS
...
- Using OLS to estimate the parameters in a linear regression is equivalent to using Bayesian inference with a ______ prior.
