...
- Feature engineering, transformations (NN are about automating feature engineering)
...
- Show that OLS and MLE (and Bayes?) are all decision problems with loss functions to minimize and select the best estimator
- Parameter estimates
