...
### Modeling Workflow Redux / Data and Decision Redux

- Reminder about evaluating exercises (e.g., "Excellent," "Good," "Needs Improvement").
- Quizzes and interviews (informally).
- Reminder about projects, iceberg illustration of projects: presentations up top and report underneath.
    - Working to have the exercises map to the project and project rubric map to the modeling workflow.
- Need to revisit the modeling workflow and the place of decision theory as a frame for it.
    - Revisit loss/utility matrix
    - Include interactions here that I'll add earlier with feature engineering before assumptions?
...
- Generalize loss and utility functions to construct non-symmetric, non-risk neutral, or non-linear utility functions.
- Include a discussion of actions, states, and consequences, with non-linear or concave/convex utility functions.
