...
- Consider: objective/loss function, data generation process/ideal dataset
...
- Build: Translate story into a mathematical model -- a functional mapping of inputs to output
...
- Prepare: Preprocess the data (what transformations?), compare the data to what you've simulated to see if you're missing something from your model
- Diagnose: Check assumptions, specific to linear models or other kinds of models (or is that just part of prepare?)
...
## Decision Theory (Sept 3; Jan 12)

Move details from Modeling Workflow down

# Week 03 (Sept 8, 10; Jan 21)

## Probability and Statistics (Sept 8; Jan 14)
