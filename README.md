...
1.  Build, evaluate, and interpret models to extract insights and inform
    decision-making by non-technical stakeholders.
2.  Diagnose and address violations of model assumptions to ensure
    appropriate model use.
3.  Clearly communicate model results in a business context.
